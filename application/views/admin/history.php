      ...
      <div class="col-xs-12">
        ...
        <div class="row" style="background-color: #F7F7F9; padding: 10px; width:100%; margin-left:1px; border-radius:10px; margin-bottom:10px">
          ...
          <div class="col-lg-10 col-sm-6">
            ...
            <?php if ($tunggakan == 12) : ?>
              <p style="font-size: 15.5px"><b class="text-success"> Sisa Tunggakan : LUNAS</b></p>
            <?php else : ?>
          ...
          <div class="col-lg-2 col-sm-6" style="margin-top: 10px">
            ...
            <img style="width:120px; border-radius:20%; border:4px solid whitesmoke;" src="<?= base_url() ?>assets/img/img_profiles/<?= $siswa[0]["gambar"] ?>" alt="<?= $data[0]["nama_petugas"] ?>">
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-body">
            ...
            <a href="<?= base_url() ?>admin/select_siswa/<?= $siswa[0]["id_kelas"] ?>" class="btn btn-primary" style="margin-top:20px">

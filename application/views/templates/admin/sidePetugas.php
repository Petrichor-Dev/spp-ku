    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?= base_url()?>assets/img/gadis.png" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/calendar.html">
            <i class="fa fa-user-circle"></i> <span>HISTORI PEMBAYARAN</span>
...
<!-- SIDE BAR YANG SEBELAH KANAN -->
  ...
  <!-- /.control-sidebar -->
  <!-- akhir side bar yang sebelah kanan -->
